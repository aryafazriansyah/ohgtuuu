...
echo "Creadby  : Mr.arya $white                                      " |lolcat
echo "Contact  : 0895xxxxxxxx   $white                             " |lolcat
echo "_____________________________________________________________"

###################################################
# Arya Achmad Fazriansyah
###################################################
trap ctrl_c INT
ctrl_c() {
clear
...
6) echo "created by : Mr.Arya" | lolcat
exit
;;
